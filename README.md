...
| 팀원 | 업무 | 브랜치 |
|:-------:|:-------:|:-------:|
| 박건용 | 큐레이팅 | featureCuration |
| 오예슬 | 답글 | 오예슬 |
| 김선영 | 스타일 등록, 수정, 삭제 | 김선영 |
| 정수영 | 스타일 조회 & 검색, 랭킹, 상세 조회, 인기 태그  | sooyoung |
...
- 큐레이션 및 이미지 생성 URL API 개발
- API 문서화 (swagger)

### 정수영

- 스타일 API 조회, 상세 조회, 랭킹 및 태그 API 개발
...
[How Do I Look](https://nb06-howdoilook-team3-front.onrender.com/)
